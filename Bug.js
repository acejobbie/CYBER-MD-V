...
break
            ...
            case 'fliptext': {
                ...
                replygcxeon(`\`\`\`「 FLIP TEXT CYBER-MD 」\`\`\`\n*•> Normal :*\n${quere}\n*•> Flip :*\n${flipe}`)
            }
            break
            case 'listvn': {
                let teks = '┌──⭓「 *List Vn CYBER-MD* 」\n│\n'
            ...
            break
            case 'liststicker': {
                let teks = '┌──⭓「 *List Sticker CYBER-MD* 」\n│\n'
...
case 'listzip': {
await loading()
let teksooooo = '┌──⭓「 *ZIP LIST CYBER-MD* 」\n│\n'
...
case 'listapk': {
await loading()
let teksoooooo = '┌──⭓「 *APK LIST CYBER-MD* 」\n│\n'
...
case 'listpdf': {
await loading()
let teksoooo = '┌──⭓「 *PDF LIST CYBER-MD* 」\n│\n'
...
"sellerJid": "94785274495@s.whatsapp.net",
